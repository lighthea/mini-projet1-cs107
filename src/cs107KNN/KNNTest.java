...
public class KNNTest {
	...
	public static void parsingTest() {
		...
		byte[][][] images = KNN.parseIDXimages(Helpers.readBinaryFile("D:\\DEVELOPPEMENT\\Projects\\knn\\mini-projet1-cs107\\datasets\\Train\\10-per-digit_images_train"));
		byte[] labels = KNN.parseIDXlabels(Helpers.readBinaryFile("D:\\DEVELOPPEMENT\\Projects\\knn\\mini-projet1-cs107\\datasets\\Train\\10-per-digit_labels_train"));
	...
	public static void knnClassifyTest() {
		...
		byte[][][] imagesTrain = KNN.parseIDXimages(Helpers.readBinaryFile("D:\\DEVELOPPEMENT\\Projects\\knn\\mini-projet1-cs107\\datasets\\Train\\10-per-digit_images_train"));
		byte[] labelsTrain = KNN.parseIDXlabels(Helpers.readBinaryFile("D:\\DEVELOPPEMENT\\Projects\\knn\\mini-projet1-cs107\\datasets\\Train\\10-per-digit_labels_train"));

		byte[][][] imagesTest = KNN.parseIDXimages(Helpers.readBinaryFile("D:\\DEVELOPPEMENT\\Projects\\knn\\mini-projet1-cs107\\datasets\\Test\\10k_images_test"));
		byte[] labelsTest = KNN.parseIDXlabels(Helpers.readBinaryFile("D:\\DEVELOPPEMENT\\Projects\\knn\\mini-projet1-cs107\\datasets\\Test\\10k_labels_test"));
